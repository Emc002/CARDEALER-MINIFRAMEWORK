...
class Router
{
  ...
  private static $baseUrl = 'http://localhost/VIEWPHP/CARDEALER-MINIFRAMEWORK/Public/';
  ...
  {
    $baseUrl = self::$baseUrl ?? 'http://localhost/VIEWPHP/CARDEALER-MINIFRAMEWORK/Public/';
    return $baseUrl . $path;
  }
